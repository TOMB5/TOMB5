...
CFILES += SPEC_PSX/PSXMAIN.C GAME/GAMEFLOW.C GAME/CONTROL.C SPEC_PSX/GPU.C GAME/TEXT.C GAME/LARA.C GAME/DELSTUFF.C GAME/DELTAPAK.C GAME/DOOR.C GAME/DRAW.C GAME/BOX.C GAME/CAMERA.C GAME/COLLIDE.C GAME/ITEMS.C GAME/DEBRIS.C GAME/SPOTCAM.C GAME/EFFECT2.C GAME/TOMB4FX.C GAME/EFFECTS.C GAME/FLMTORCH.C GAME/HAIR.C GAME/HEALTH.C GAME/NEWINV2.C GAME/LARAFIRE.C GAME/LARAFLAR.C GAME/LARA1GUN.C GAME/LARA2GUN.C GAME/LARACLMB.C GAME/LARASWIM.C GAME/LARASURF.C GAME/LOT.C GAME/LARAMISC.C GAME/MISSILE.C GAME/OBJECTS.C GAME/PEOPLE.C GAME/SAVEGAME.C GAME/SOUND.C GAME/SPHERE.C GAME/SWITCH.C GAME/PICKUP.C GAME/OBJLIGHT.C
CFILES += SPEC_PSX/3D_GEN.C SPEC_PSX/CD.C GAME/TRAPS.C SPEC_PSX/FILE.C SPEC_PSX/MALLOC.C SPEC_PSX/3D_OBJ.C SPEC_PSX/PSXINPUT.C SPEC_PSX/ROOMLOAD.C SPEC_PSX/LOAD_LEV.C SPEC_PSX/DRAWSPKS.C SPEC_PSX/PSOUTPUT.C SPEC_PSX/SPECIFIC.C SPEC_PSX/PROFILE.C SPEC_PSX/MEMCARD.C SPEC_PSX/SPUSOUND.C SPEC_PSX/LOADSAVE.C SPEC_PSX/REQUEST.C SPEC_PSX/DRAWPHAS.C SPEC_PSX/MISC.C SPEC_PSX/TEXT_S.C SPEC_PSX/MATHS.C SPEC_PSX/SETUP.C SPEC_PSX/BUBBLES.C GAME/CODEWAD.C SPEC_PSX/MOVIE.C SPEC_PSX/COLLIDE_S.C SPEC_PSX/SFX.C SPEC_PSX/FXTRIG.C SPEC_PSX/CONTROL_S.C SPEC_PSX/CALCLARA.C SPEC_PSX/ROOMLETB.C SPEC_PSX/DELTAPAK_S.C SPEC_PSX/SHADOWS.C SPEC_PSX/FXDRAW.C SPEC_PSX/PRINTOBJ.C SPEC_PSX/ANIMITEM.C
