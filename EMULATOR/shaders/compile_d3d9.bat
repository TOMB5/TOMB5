...
fxc /nologo /T vs_3_0 /O3 /Gec /Vn gte_shader_16_vs /Fh gte_shader_16_vs.h gte_shader_16.hlsl /DVERTEX
fxc /nologo /T ps_3_0 /O3 /Gec /Vn gte_shader_16_ps /Fh gte_shader_16_ps.h gte_shader_16.hlsl /DPIXEL
