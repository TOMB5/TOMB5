...
{
	int state = 0; // $s1
	unsigned char type = 0; // $s2
	unsigned long in = 0; // $s0
	static unsigned long Pad2 = 0; // offset 0x0
	static int pause_db = 0; // offset 0xc
	static int option_db = 0; // offset 0x10
	static char LookCnt = 0; // offset 0x14
