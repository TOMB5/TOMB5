...
void sub_1184L4()//(F)
{
    ...
    do
    {
        ...
        if (s1->counter != 0)
        {
            sub_FC0L4(s1->pos.x_pos, s1->pos.y_pos, s1->pos.z_pos);
...
void sub_1330L4(struct ITEM_INFO* item)
{
...
void sub_E38L4()//(F)
{
    ...
    do
    {
        sub_FC0L4(h->pos.x_pos, h->pos.y_pos, h->pos.z_pos);
        sub_D7CL4(h->pos.y_rot);
