...
char* SubPolyGT3RL1(int* t0, int* t1, int* s1, int* a3, int s3)
{
    int gp;
    int* t1;
    int t2;
    ...
    do
    {
        ...
        if (t7 != 0)
        {
            ...
            if ((unsigned)at < 0x180u && s3 == 0)
            {
                ...
                s6 = (int)t0;
                //t0 = TriVertTables[gp]
                a3 = (int*)SubPolyGT3RL1((int*)&TriVertTables[gp], &s1[216], s1, a3, s3);
        ...
        if (ClipXYRL1(t1, t2, t3, t4) == 0)
        {
            ...
            if (t5 < 0x9E0)
            {
                ...
                if (at != 0)
                {
                    ...
                    s3 = 0;
                    a3 = (int)SubPolyGT3RL1((int*)TriVertTableRL1[0], (int*)&s1[201], (int*)s1, (int*)a3, s3);
