...
{
	db.order_table[0] = (uintptr_t*)((uintptr_t)&pBuffers[0]);
	db.order_table[1] = (uintptr_t*)((uintptr_t)&pBuffers[nOTSize]);
	db.nOTSize = nOTSize;
	db.pickup_order_table[0] = (uintptr_t*)((uintptr_t)&GadwOrderingTables_V2[0]);
	db.pickup_order_table[1] = (uintptr_t*)((uintptr_t)&GadwOrderingTables_V2[256]);
	return;
}
...
{
	db.nPBSize = nPBSize;
	db.poly_buffer[0] = (unsigned long*)((uintptr_t)&pBuffers[0]);
	db.poly_buffer[1] = (unsigned long*)((uintptr_t)&pBuffers[nPBSize]);
	return;
}
