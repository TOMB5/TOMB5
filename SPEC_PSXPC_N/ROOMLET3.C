...
int* InitSubdivisionRL3(int* s1, int t1, int s4, int fp, int t5, int t2, int s5, int gp, int t6, int t3, int s6, int s3, int t7, int s7)
{
    s1[186] = t1;
    ((short*)s1)[374] = s4;
    t1 = fp << 8;
    ...
    do
    {
        ...
        if (t5 == 0)
        {
            ...
            if (t5 < 0x9E0)
            {
                ...
                t8 = ((int*)t00)[2];
                int fpp;
                UnpackRGBRL3(&s444, &t8, &s555, &s666, &fpp, &gp, &t5, &t6, &s3);
                t5 = s777 >> 7;
                t5 += s2;
                t6 = s777 >> 10;
                t6 &= 0xF800;
                ...
                if (at != 0)
                {
                    ...
                    a3 = (int)SubPolyGT4RL3((int*)QuadVertTable[0], (int*)&s1[824], (int*)s1, (int*)a3, (int)s0, s3, fpp);
                    t0 = (LB1 & 0xFFFF) | ((LB2 & 0xFFFF) << 16);
                    at = BFC;
                    t9 = DQA;
