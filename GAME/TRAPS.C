...
static PHD_VECTOR FloorTrapDoorPos = { 0, 0, 0xFFFFFD71 }; // offset 0xA16B8
static short FloorTrapDoorBounds[12] = // offset 0xA16C4
{
	0xFF00, 0x0100, 0x0000, 0x0000, 0xFC00, 0xFF00, 0xF8E4, 0x071C, 0xEAAC, 0x1554, 
	0xF8E4, 0x071C
};
static PHD_VECTOR CeilingTrapDoorPos = { 0, 0x420, 0xFFFFFE20 }; // offset 0xA16DC
...
int TestBoundsCollideTeethSpikes(ITEM_INFO* item)//5BE64, 5C2E0
{
...
int OnTwoBlockPlatform(ITEM_INFO* item, long x, long z)//5BB80, 5BFFC
{
	S_Warn("[OnTwoBlockPlatform] - Unimplemented!\n");
	return 0;
}

void TwoBlockPlatformCeiling(ITEM_INFO* item, long x, long y, long z, long* height)//5BB08, 5BF84
{
	S_Warn("[TwoBlockPlatformCeiling] - Unimplemented!\n");
	return;
}

void TwoBlockPlatformFloor(ITEM_INFO* item, long x, long y, long z, long* height)//5BA80, 5BEFC
{
	S_Warn("[TwoBlockPlatformFloor] - Unimplemented!\n");
	return;
}

void DrawScaledSpike(ITEM_INFO* item)//5B854, 5BCD0
{
	S_Warn("[DrawScaledSpike] - Unimplemented!\n");
	return;
}

void RollingBallCollision(short item_number, ITEM_INFO* laraitem, COLL_INFO* coll)//5B750, 5BBCC
{
...
void LavaBurn(ITEM_INFO* item)//5AD78, 5B1F4
{
...
void FallingBlockCeiling(ITEM_INFO* item, long x, long y, long z, long* height)//596D4, 59B50
{
	S_Warn("[FallingBlockCeiling] - Unimplemented!\n");
	return;
}

void FallingBlockFloor(ITEM_INFO* item, long x, long y, long z, long* height)//59674, 59AF0
{
...
void FallingBlockCollision(short item_number, ITEM_INFO* l, COLL_INFO* coll)//5947C, 598F8
{
	S_Warn("[FallingBlockCollision] - Unimplemented!\n");
	return;
}

void TrapDoorCollision(short item_num, ITEM_INFO* l, COLL_INFO* coll)//593F8, 59874
{
	S_Warn("[TrapDoorCollision] - Unimplemented!\n");
	return;
}

void CeilingTrapDoorCollision(short item_num, ITEM_INFO* l, COLL_INFO* coll)//5912C, 595A8
{
	S_Warn("[CeilingTrapDoorCollision] - Unimplemented!\n");
	return;
}

void FloorTrapDoorCollision(short item_num, ITEM_INFO* l, COLL_INFO* coll)//58E80, 592FC
{
...
void CloseTrapDoor(ITEM_INFO* item)//58B68, 59008
{
	S_Warn("[CloseTrapDoor] - Unimplemented!\n");

}

void OpenTrapDoor(ITEM_INFO* item)//58A1C, 58EBC
{
