...
static PHD_VECTOR JumpSwitchPos = { 0, 0xFFFFFF30, 0x100 }; // offset 0xA15A4
static PHD_VECTOR CrowbarPos = { 0xFFFFFFA7, 0, 0xFFFFFEB8 }; // offset 0xA15B0
static short CrowbarBounds[12] = // offset 0xA15BC
{
	0xFF00, 0x0100, 0x0000, 0x0000, 0xFE00, 0xFF00, 0xF8E4, 0x071C, 0xEAAC, 0x1554, 
	0xF8E4, 0x071C
};
static PHD_VECTOR CrowbarPos2 = { 0x59, 0, 0x148 }; // offset 0xA15D4
...
static PHD_VECTOR FullBlockSwitchPos = { 0, 0, 0 }; // offset 0xA1610
static short PulleyBounds[12] = // offset 0xA161C
{
	0xFF00, 0x0100, 0x0000, 0x0000, 0xFE00, 0x0200, 0xF8E4, 0x071C, 0xEAAC, 0x1554, 
	0xF8E4, 0x071C
};
static PHD_VECTOR PulleyPos = { 0, 0, 0xFFFFFF6C }; // offset 0xA1634
static PHD_VECTOR CrowDovePos = { 0, 0, 0xFFFFFE70 }; // offset 0xA1640
...
static PHD_VECTOR UnderwaterSwitchPos = { 0, 0xFFFFFD20, 0xFFFFFE60 }; // offset 0xA167C
static PHD_VECTOR UnderwaterSwitchPos2 = { 0, 0xFFFFFD20, 0x1A0 }; // offset 0xA1688
static short SwitchBounds[12] = // offset 0xA1694
{
	0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0xF8E4, 0x071C, 0xEAAC, 0x1554, 
	0xF8E4, 0x071C
};
static PHD_VECTOR SwitchPos = { 0, 0, 0 }; // offset 0xA16AC

void ProcessExplodingSwitchType8(ITEM_INFO* item)//58958, 58DF8 (F)
{
	PHD_VECTOR pos;
	pos.x = 0;
	pos.y = 0;
...
void CrowDoveSwitchCollision(short item_num, ITEM_INFO* l, COLL_INFO* coll)//58740, 58BE0
{
...
void CogSwitchCollision(short item_num, ITEM_INFO* l, COLL_INFO* coll)//58354, 587F4
{
...
void FullBlockSwitchCollision(short item_num, ITEM_INFO* l, COLL_INFO* coll)//57FB8, 58458
{
...
void CrowbarSwitchCollision(short item_num, ITEM_INFO* l, COLL_INFO* coll)//57ACC, 57F6C
{
	S_Warn("[CrowbarSwitchCollision] - Unimplemented!\n");
	return;
}

void JumpSwitchCollision(short item_num, ITEM_INFO* l, COLL_INFO* coll)//57980, 57E20
{
	S_Warn("[JumpSwitchCollision] - Unimplemented!\n");
	return;
}

void RailSwitchCollision(short item_num, ITEM_INFO* l, COLL_INFO* coll)//576F4, 57B94
{
	S_Warn("[RailSwitchCollision] - Unimplemented!\n");
	return;
}

void TurnSwitchCollision(short item_num, ITEM_INFO* l, COLL_INFO* coll)//57210, 576B0
{
...
void PulleyCollision(short item_num, ITEM_INFO* l, COLL_INFO* coll)//56C98, 57138
{
	S_Warn("[PulleyCollision] - Unimplemented!\n");
	return;
}

void UnderwaterSwitchCollision(short item_num, ITEM_INFO* l, COLL_INFO* coll)//56A2C, 56ECC
{
	S_Warn("[UnderwaterSwitchCollision] - Unimplemented!\n");
	return;
}

void SwitchCollision2(short item_num, ITEM_INFO* l, COLL_INFO* coll)//568C0, 56D60
{
	S_Warn("[SwitchCollision2] - Unimplemented!\n");
	return;
}

void SwitchCollision(short item_num, ITEM_INFO* l, COLL_INFO* coll)//56470, 56910
{
...
int GetKeyTrigger(ITEM_INFO* item)//56080, 56520
{
	S_Warn("[GetKeyTrigger] - Unimplemented!\n");
	return 0;
}

int GetSwitchTrigger(ITEM_INFO* item, short* ItemNos, long AttatchedToSwitch)//55F4C, 563EC
{
