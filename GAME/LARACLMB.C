...
void lara_col_climbdown(ITEM_INFO* item, COLL_INFO* coll)//46BD0, 47034
{
...
void lara_col_climbing(ITEM_INFO* item, COLL_INFO* coll)//469B0, 46E14
{
...
void lara_as_climbstnc(ITEM_INFO* item, COLL_INFO* coll)//463F0, 46854
{
	S_Warn("[lara_as_climbstnc] - Unimplemented!\n");
}

int LaraTestClimbPos(ITEM_INFO* item, int front, int right, int origin, int height, int* shift)//462F8, 4675C
{
	S_Warn("[LaraTestClimbPos] - Unimplemented!\n");
	return 0;
}

void LaraDoClimbLeftRight(ITEM_INFO* item, COLL_INFO* coll, int result, int shift)//46100, 46564
{
...
long LaraCheckForLetGo(ITEM_INFO* item, COLL_INFO* coll)//45434, 45898
{
